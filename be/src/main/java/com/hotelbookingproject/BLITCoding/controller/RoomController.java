...
import com.hotelbookingproject.BLITCoding.exception.PhotoRetrievalException;
...
public class RoomController {
    ...
    public ResponseEntity<Optional<RoomResponse>>
    getRoomByID(@PathVariable Long roomId)
             {
